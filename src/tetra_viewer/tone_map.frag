...
vec3 composite_long_aerial(vec3 surface_radiance,float distance_metres) {
...
vec3 composite_aerial(vec3 surface_radiance,float distance_metres) {
  ...
  if(faithful&&distance_metres>local_distance*0.75){
    const vec3 long_result=composite_long_aerial(
  ...
  if(faithful)return local_result;
